            ...
            <div class="col-xl-8 col-lg-7 order-box-1">
                ...
                <div class="blog_form contact-style2_form">
                    ...
                    <div class="contact-form">
                        <form wire:submit.prevent="editProduct" id="contact-form" name="contact_form" class="default-form2" enctype="multipart/form-data"  method="post">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="input-box">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="input-box">
                                        ...
                                        @else
                                            <img src="{{ asset('asset/image/blogs') }}/{{ $image }}" width="120" alt="">
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="button-box text-center">
                                        <button class="btn-one" type="submit" data-loading-text="Please wait...">
                                            <span class="txt"><i class="left flaticon-login"></i>Update Blog</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
